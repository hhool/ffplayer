...
static int default_interrupt_cb(void* This);
...
void url_set_interrupt_cb(URLInterruptCB *interrupt_cb,void* This)
{
    avio_set_interrupt_cb(interrupt_cb,This);
}
                                         ...
                                         int (*transfer_func)(URLContext *h, unsigned char *buf, int size))
{
    ...
    while (len < size_min) {
        ...
        len += ret;
        if (len < size && url_interrupt_cb(gThis))
            return AVERROR_EXIT;
    }
    return len;
}
...
void avio_set_interrupt_cb(int (*interrupt_cb)(void*),void* This)
{
    if (!interrupt_cb)
