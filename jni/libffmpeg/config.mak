...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=linux --arch=arm --enable-shared --enable-cross-compile --cc='d:/ndkr6b/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-gcc' --cross-prefix='d:/ndkr6b/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-' --strip='d:/ndkr6b/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-strip' --extra-cflags='-fPIC -DANDROID -DNDEBUG -Id:/ndkr6b/platforms/android-4/arch-arm/usr/include' --extra-ldflags='-Wl,-T,d:/ndkr6b/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/arm-linux-androideabi/lib/ldscripts/armelf_linux_eabi.x -Wl,-rpath-link=d:/ndkr6b/platforms/android-4/arch-arm/usr/lib -Ld:/ndkr6b/platforms/android-4/arch-arm/usr/lib -nostdlib d:/ndkr6b/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/lib/gcc/arm-linux-androideabi/4.4.3/crtbegin.o d:/ndkr6b/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/lib/gcc/arm-linux-androideabi/4.4.3/crtend.o -lc -lm -ldl' --disable-gpl --disable-nonfree --disable-debug --disable-ffmpeg --disable-ffplay --disable-ffserver --disable-ffprobe --disable-encoders --disable-muxers --disable-devices --disable-avfilter --disable-avdevice --enable-version3 --enable-swscale --enable-network --enable-parsers --enable-decoders --enable-demuxers
prefix=/usr/local
...
SRC_PATH="/cygdrive/f/project/TSPlayer/other/ff/jni/libffmpeg"
SRC_PATH_BARE=/cygdrive/f/project/TSPlayer/other/ff/jni/libffmpeg
CC_IDENT=gcc 4.4.3 (GCC)
ARCH=arm
CC=d:/ndkr6b/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-gcc
AS=d:/ndkr6b/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-gcc
LD=d:/ndkr6b/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-gcc
DEPCC=d:/ndkr6b/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-gcc
YASM=yasm
YASMDEP=yasm
AR=d:/ndkr6b/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-ar
RANLIB=d:/ndkr6b/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-ranlib
CP=cp -p
LN_S=ln -sf
STRIP=d:/ndkr6b/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-strip
CPPFLAGS= -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -D_POSIX_C_SOURCE=200112 -D_XOPEN_SOURCE=600 -DPIC
CFLAGS= -fPIC -DANDROID -DNDEBUG -Id:/ndkr6b/platforms/android-4/arch-arm/usr/include  -std=c99 -fomit-frame-pointer -fPIC -marm -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes
ASFLAGS= -fPIC -DANDROID -DNDEBUG -Id:/ndkr6b/platforms/android-4/arch-arm/usr/include  -fPIC
CC_O=-o $@
LDFLAGS= -Wl,-T,d:/ndkr6b/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/arm-linux-androideabi/lib/ldscripts/armelf_linux_eabi.x -Wl,-rpath-link=d:/ndkr6b/platforms/android-4/arch-arm/usr/lib -Ld:/ndkr6b/platforms/android-4/arch-arm/usr/lib -nostdlib d:/ndkr6b/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/lib/gcc/arm-linux-androideabi/4.4.3/crtbegin.o d:/ndkr6b/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/lib/gcc/arm-linux-androideabi/4.4.3/crtend.o -lc -lm -ldl -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link,libpostproc -Wl,-rpath-link,libswscale -Wl,-rpath-link,libavfilter -Wl,-rpath-link,libavdevice -Wl,-rpath-link,libavformat -Wl,-rpath-link,libavcodec -Wl,-rpath-link,libavutil
