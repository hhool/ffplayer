...
UINT32 UtilCrc32::UpdateCrc (char *buf, int len) {
    UINT32 crc = muValue;
    for (int i = 0; i < len; i++) {
...
UINT32 UtilCrc32::GetResult () {
    return muValue ^ 0xFFFFFFFF;
}


UINT32 UtilCrc32::crcTable[] = {   
...
UINT32 UtilCrc32::crc32(unsigned char* bytes, int len)
{
