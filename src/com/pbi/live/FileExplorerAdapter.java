...
public class FileExplorerAdapter extends BaseAdapter {
	...
	private void setRow(ViewHolder holder, int position) {
		...
		if(file.isDirectory())
		{
			holder.icon.setImageDrawable(mContext.getResources().getDrawable(R.drawable.folder_48));
		} 
		else if (file.isFile()) 
		{
			holder.icon.setImageDrawable(mContext.getResources().getDrawable(R.drawable.file_48));
		} 
		else {
